...
public class App extends PApplet {
    ...
    /**
     * The triangle object that is at the bottom of the screen.
     */
    ...
    public void setup() {
        ...
        this.triangle.setSprite(this.loadImage("src/main/resources/triangle.png"));
    }
    ...
    public void keyPressed() {
        ...
        if (this.keyCode == 37) {
            ...
            this.square.pressDown();
        }
        if (this.keyCode == 32) {
            this.triangle.pressspace();
        }
    }
